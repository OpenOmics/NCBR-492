...
seqtk seq -1 ${UNMAPPED_INTERCLEAVED} > ${UNMAPPED_R1}
seqtk seq -2 ${UNMAPPED_INTERCLEAVED} > ${UNMAPPED_R2}


# KRAKEN
echo "Input trimmed R1 is ${UNMAPPED_R1}"
echo "Input trimmed R2 is ${UNMAPPED_R2}" 
...
--report ${KRAKEN}/${PR}.unmapped.kraken.taxa.txt \
--output ${KRAKEN}/${PR}.unmapped.kraken.out.txt
